...
fn test_basic() {
    ...
    let compare = BTreeMap::from([
        ...
        (
            "int_field".to_string(),
            CellValue::Number(Number::from(1i32)),
        ),
    ]);
...
fn test_nesting() {
    let r = Record2 {
        nest: Record {
            string_field: "nesting".to_string(),
            int_field: 15,
        },
        string_field: "hello".to_string(),
        int_field: 1,
...
fn test_array() {
    ...
    let r = Record7 {
        nest: vec![
            ...
            Record6 {
                string_field: "nosting".to_string(),
                int_field: 1,
            },
            Record6 {
                string_field: "nisting".to_string(),
                int_field: 12,
            },
            Record6 {
                string_field: "nasting".to_string(),
                int_field: 11,
            },
            Record6 {
                string_field: "nusting".to_string(),
                int_field: 52,
            },
        ],
        string_field: "hello".to_string(),
